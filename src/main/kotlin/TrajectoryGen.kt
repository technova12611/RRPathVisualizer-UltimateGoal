...
object TrajectoryGen {
    private val constraints = MecanumConstraints(
                                  DriveConstraints(50.0, 45.0, 0.0,
                                      180.0.toRadians, 180.0.toRadians, 0.0),
                                 13.5,13.5)
    private val max_constraints = MecanumConstraints(
                                  DriveConstraints(65.0, 65.0, 0.0, 220.0.toRadians, 320.0.toRadians, 0.0),
        13.5,13.5)
    ...
    fun testUltimateGoalPath(): ArrayList<Trajectory> {
        ...
        var builder0 = TrajectoryBuilder(Pose2d(-63.0, -15.0, 0.0.toRadians), 0.0.toRadians,constraints)

        builder0.splineTo(Vector2d(-36.0,-15.0), 0.0.toRadians )
        //                .splineTo(Vector2d(0.0,-34.0), 0.0.toRadians )
        list.add(builder0.build())

        builder0 = TrajectoryBuilder(Pose2d(-36.0, -15.0, 0.0.toRadians), 0.0.toRadians,constraints)
        builder0.lineTo(Vector2d(-36.0,-36.0))
        list.add(builder0.build())

        builder0 = TrajectoryBuilder(Pose2d(-36.0, -36.0, 0.0.toRadians), 0.0.toRadians,constraints)
//        builder0.lineToLinearHeading(Pose2d(54.0, -45.0, 0.0.toRadians))
        builder0.splineTo(Vector2d(61.0, -42.0), 0.0.toRadians)
        list.add(builder0.build())

        builder0 = TrajectoryBuilder(Pose2d(61.0, -42.0,0.0.toRadians), true,constraints)
        builder0.lineToLinearHeading(Pose2d(-33.0, -40.0, 0.0.toRadians))
        list.add(builder0.build())

        builder0 = TrajectoryBuilder(Pose2d(-33.0, -40.0,0.0.toRadians), true,constraints)
        builder0.lineToLinearHeading(Pose2d(55.0, -48.0, 0.0))
        list.add(builder0.build())

        builder0 = TrajectoryBuilder(Pose2d(55.0, -48.0,0.0.toRadians), true,constraints)
        builder0.splineTo(Vector2d(32.0, -2.0), (180.0 - 90.0).toRadians)
        list.add(builder0.build())

        builder0 = TrajectoryBuilder(Pose2d(32.0, -2.0, (-90.0).toRadians), true,constraints)
        builder0.splineToLinearHeading(Pose2d(-8.0, -36.0, (0.0).toRadians), 180.0.toRadians)
        list.add(builder0.build())

        builder0 = TrajectoryBuilder(Pose2d(-8.0, -36.0, 0.0.toRadians), true,constraints)
    ...
    fun testHeadingInterpolators(): ArrayList<Trajectory> {
        ...
        val list = ArrayList<Trajectory>()
        var builder0 = TrajectoryBuilder(Pose2d(56.5, -39.0, 90.0.toRadians), 90.0.toRadians,constraints)
        builder0.lineToLinearHeading(Pose2d(56.5, -30.0, 90.0.toRadians))

        list.add(builder0.build())

        builder0 = TrajectoryBuilder(Pose2d(56.5, -30.0,  90.0.toRadians), 90.0.toRadians,constraints)
    ...
    fun testHeadingInterpolators2(): ArrayList<Trajectory> {
        ...
        builder1 = TrajectoryBuilder(Pose2d(-60.0, -40.0, 180.0.toRadians),true, constraints)
